(function () {
     ...
     * @constructor
     */
    var quarkDB = function (filename, saveOnPush, humanReadable) {
    ...
    quarkDB.prototype._processDataPath = function (dataPath) {
    ...
    quarkDB.prototype._getParentData = function (dataPath, create) {
     ...
     * @returns {*}
     */
    quarkDB.prototype.getData = function (dataPath) {
        var path = this._processDataPath(dataPath);
        return this._getData(path);
    };

    quarkDB.prototype._getData = function (dataPath, create) {
     ...
     */
    quarkDB.prototype.push = function (dataPath, data, override) {
     ...
     * @param dataPath path leading to the data
     */
    quarkDB.prototype.delete = function (dataPath) {
        dataPath = JsonUtils.removeTrailingSlash(dataPath);
        var dbData = this._getParentData(dataPath, true);
        if (!dbData) {
            return;
     ...
     * @returns {*}
     */
    quarkDB.prototype.reload = function () {
        this.loaded = false;
        return this.load();
    };
    /**
     ...
     */
    quarkDB.prototype.load = function () {
        if (this.loaded) {
            return;
        }
        try {
     ...
     */
    quarkDB.prototype.save = function (force) {
        force = force || false;
